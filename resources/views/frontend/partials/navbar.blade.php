        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/">
                        ...
                        <img src="{{ asset('img/logo_ngamplop_panjang.png') }}" alt="logo" class="h-10 w-auto">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <a href="#home"
                        class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-blue-700 transition duration-150 ease-in-out hover:border-b hover:border-blue-500 ">
                        Home
                    </a>
                    <a href="#feature"
                        class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-blue-700 transition duration-150 ease-in-out hover:border-b hover:border-blue-500">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @else
                    <div class="space-x-2">
                        <a href="{{ route('login') }}"
                            class="py-2 px-6 bg-blue-500 rounded-md text-sm font-semibold text-white leading-normal">Login</a>
                        <a href="{{ route('register') }}"
                            class="py-2 px-6 bg-blue-500 rounded-md text-sm font-semibold text-white leading-normal">Register</a>
                    </div>
                @endauth
